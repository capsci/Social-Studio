$(document).ready(function() {
	...
	var binaryCanvas = document.getElementById("canvasBinary");
	var rgbCanvasCalc = document.getElementById("canvasRGBfilterCalc");
	var rgbCanvas = document.getElementById("canvasRGBfilter");
	var hsvCanvas = document.getElementById("canvasHSVfilter");
	var healingCanvas = document.getElementById("canvasHealing");
...
*/
	videoFeed.addEventListener('play', function() {
		...
		setInterval(function() {
			...
			preprocessing.healing(healingCanvas, hsvCanvas);
...
//			gestures.medianCoM(healingCanvas);
			...
			gestures.manipMedianCom(healingCanvas);

			preprocessing.saveFrameData(healingCanvas);
